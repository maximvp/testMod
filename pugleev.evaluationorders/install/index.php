...
Class pugleev_evaluationorders extends CModule{
	var	$MODULE_ID = 'pugleev.evaluationorders';
    var $MODULE_SORT = 10;
	var $MODULE_VERSION;
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage("PUGLEEV_EVALUATIONORDERS_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("PUGLEEV_EVALUATIONORDERS_MODULE_DESC");

		$this->PARTNER_NAME = getMessage("PUGLEEV_EVALUATIONORDERS_PARTNER_NAME");
		$this->PARTNER_URI = getMessage("PUGLEEV_EVALUATIONORDERS_PARTNER_URI");
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("PUGLEEV_EVALUATIONORDERS_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("PUGLEEV_EVALUATIONORDERS_INSTALL"), $this->GetPath()."/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("PUGLEEV_EVALUATIONORDERS_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}
?>